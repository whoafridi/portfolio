...
const Contact: React.FC = () => {
  return (
    <>
      <Head>
        <title>Contact - RoseTech Solutions LTD</title>
      </Head>
            ...
            <div className="col-md-8">
              ...
              <form className="row g-3 my-5">
                ...
                <div className="col-12 py-3">
                  ...
                  />
                  <label
                    className="btn btn-outline-warning px-3 me-2 mt-3 mt-md-0"
                    htmlFor="technical"
                  >
                  ...
                  />
                  <label
                    className="btn btn-outline-warning px-3 me-2 mt-3"
                    htmlFor="website"
                  >
                    Website & SEO
                  </label>
                ...
                <div className="col-12">
                  <label htmlFor="wheretoknowus" className="pb-2">
                    How Do You Know Us?(আমাদের সম্পর্কে কিভাবে জেনেছেন?)
                  </label>
                  <div className="col-12">
                    <select
